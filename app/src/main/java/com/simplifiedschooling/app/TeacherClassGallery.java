...
public class TeacherClassGallery extends ActionBarActivity {
	private static final String TAG = TeacherClassGallery.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGallery.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent i = new Intent(TeacherClassGallery.this, ClassGalleryView.class);
								...
								try {
									...
									for (int i = 0; i < calssdetails.length(); i++) {
										...
										ArrayAdapter<String> classlistadapter = new ArrayAdapter<String>(
												TeacherClassGallery.this, android.R.layout.simple_spinner_item,
												calssList);
