...
public class TopicforRevision extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startWebView(AppConfig.CLIENT_URL+"topicforrevisionmob/"+id);
        Log.d("Url",AppConfig.CLIENT_URL+"topicforrevisionmob/"+id);
    }
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(TopicforRevision.this);
