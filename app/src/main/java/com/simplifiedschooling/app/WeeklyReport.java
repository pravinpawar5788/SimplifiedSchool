...
public class WeeklyReport extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startWebView(AppConfig.CLIENT_URL+"classweeklyreportmobs/"+id);
        Log.d("Url",AppConfig.CLIENT_URL+"classweeklyreportmobs/"+id);
    }
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(WeeklyReport.this);
