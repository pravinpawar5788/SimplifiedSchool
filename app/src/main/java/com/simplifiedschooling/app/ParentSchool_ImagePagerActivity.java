...
public class ParentSchool_ImagePagerActivity extends Activity {
	private static final String TAG = ParentSchool_ImagePagerActivity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mContext = ParentSchool_ImagePagerActivity.this;
	...
	private class downloadListener implements OnLongClickListener {
		...
		public boolean onLongClick(View v) {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(
					ParentSchool_ImagePagerActivity.this);
					...
					.setPositiveButton("Yes",
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									new DownloadTask(ParentSchool_ImagePagerActivity.this)
											.execute(download_path);
...
*/	
	...
	private class DownloadTask extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(ParentSchool_ImagePagerActivity.this);
			pDialog.setMessage("Please wait...");
			pDialog.setCancelable(false);
			pDialog.show();
		}
		...
		protected void onPostExecute(String result) {
			...
			if (result != null)
				...
				Toast.makeText(context, "File downloaded", Toast.LENGTH_SHORT)
						.show();
			new SingleMediaScanner(ParentSchool_ImagePagerActivity.this, outputFile);
