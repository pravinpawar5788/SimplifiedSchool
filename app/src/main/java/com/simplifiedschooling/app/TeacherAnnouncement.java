...
public class TeacherAnnouncement extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        startWebView(AppConfig.CLIENT_URL+"techaerannouncementsmob/"+id);
		...
		web.setWebViewClient(new WebViewClient() {
			...
			public void onLoadResource(WebView view, String url) {
				if (progressDialog == null) {
					...
					progressDialog = new ProgressDialog(TeacherAnnouncement.this);
