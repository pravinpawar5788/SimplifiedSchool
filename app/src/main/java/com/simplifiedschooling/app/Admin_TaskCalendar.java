...
public class Admin_TaskCalendar extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   //	web.loadUrl(AppConfig.CLIENT_URL+"timetabletechveiw/"+id);
		startWebView(AppConfig.CLIENT_URL+"taskcalendarmob/"+id);
		...
		web.setWebViewClient(new WebViewClient() {
			...
			public void onLoadResource(WebView view, String url) {
				if (progressDialog == null) {
					...
					progressDialog = new ProgressDialog(Admin_TaskCalendar.this);
