...
public class CreateLessonPlan extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        i.setData(Uri.parse(AppConfig.CLIENT_URL+"worksheetsmob"));
        startActivity(i);
		...
		web.setWebViewClient(new WebViewClient() {
			...
			public void onLoadResource(WebView view, String url) {
				if (progressDialog == null) {
					...
					progressDialog = new ProgressDialog(CreateLessonPlan.this);
