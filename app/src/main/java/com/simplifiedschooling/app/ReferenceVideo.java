...
public class ReferenceVideo extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startWebView(AppConfig.CLIENT_URL+"referencevideomob/"+id);
        Log.d("Url",AppConfig.CLIENT_URL+"referencevideomob/"+id);
    }
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource(WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog(ReferenceVideo.this);
