...
public class ParentSchoolCalendar extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        startWebView(AppConfig.CLIENT_URL+"schoolcalendarmob");
		...
		web.setWebViewClient(new WebViewClient() {
			...
			public void onLoadResource(WebView view, String url) {
				if (progressDialog == null) {
					...
					progressDialog = new ProgressDialog(ParentSchoolCalendar.this);
